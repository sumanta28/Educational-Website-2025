...
//   const bucketId = process.env.NEXT_PUBLIC_APPWRITE_STUDENTSPROFILE_COLLECTION_ID!;
//   return storage.getFilePreview(bucketId, fileId); // now has 2 required arguments
// };
...
//                   <Avatar
//                     src={
//                       user?.imageUrl ? getImageUrl(user.imageUrl) : undefined
//                     }
//                     alt={user?.name}
//                   >
...
//                   <>
//                     <ListItem disablePadding>
//                       <ListItemButton onClick={() => router.push("/addCourse")}>
//                         Add Course
//                       </ListItemButton>
//                     </ListItem>
//                     <ListItem disablePadding>
  ...
  useEffect(() => {
    const loadAvatar = async () => {
      if (user?.imageUrl) {
        ...
        try {
          const url = await storage.getFilePreview(bucketId, user.imageUrl);
          setAvatarUrl(url);
        } catch (err) {
          ...
          <List>
            ...
            {isLoggedIn && (
              <>
                ...
                <ListItem disablePadding>
                  <ListItemButton onClick={() => router.push("/my-enrollments")}>
                    My Enrollments
                  </ListItemButton>
                </ListItem>
                {isAdmin && (
